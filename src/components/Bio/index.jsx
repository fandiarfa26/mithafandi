  ...
  return (
    <div id="bio" className='px-5 pb-10 lg:px-20'>
      <div className="space-y-5">
        ...
        <div className='text-center lg:text-xl font-bree'>Assalamu'alaikum warahmatullahi wabarakatuh</div>
        <p className='text-sm text-center lg:text-base'>Maha Suci Allah yang telah menciptakan makhluk-Nya berpasang-pasangan. <br/> Kami mengundang {greet} untuk menghadiri acara pernikahan kami.</p>
        <div className="flex flex-col items-start gap-5 py-5 lg:flex-row lg:gap-2">
          <BioItem 
            ...
            detail="Putri ketiga dari Bapak Maharani Kahar & Ibu St. Rumiyati"
            instagram="dsyrsmitam"/>
          <img src={flower} alt="Flower" className='self-center h-28 lg:h-32' />
          <BioItem 
            pic="https://dummyimage.com/500/4d4d4d/fff"
            name="M. Fandi Arfabuma, S.T."
            detail="Putra pertama dari Bapak Suhardi & Ibu Latifah"
            instagram="fandiarfa"/>
        </div>
      </div>
    </div>
