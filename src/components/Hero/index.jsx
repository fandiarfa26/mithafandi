...
const Hero = () => {
  return (
    <div id="hero" className='z-50 flex items-center justify-center w-full p-5 bg-fixed bg-opacity-50 bg-center bg-cover lg:h-screen lg:px-0 bg-ijo-dark bg-blend-darken' style={{ backgroundImage: `url(${heroImage})`}}>
